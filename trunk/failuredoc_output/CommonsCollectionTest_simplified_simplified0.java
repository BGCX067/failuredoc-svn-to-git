...
public class CommonsCollectionTest_simplified_simplified0 extends TestCase {

  // Runs all the tests in this file.
  public static void main(String[] args) {
    junit.textui.TestRunner.run(CommonsCollectionTest_simplified_simplified0.class);
  }
