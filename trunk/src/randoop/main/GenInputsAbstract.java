...
public abstract class GenInputsAbstract extends CommandHandler {
  ...
  /**
   * The following options are for failure doc
   * */
  @Option("Use FailureDoc algorithm to create debugging clues for failed tests.")
  public static boolean failure_doc = false;
  
  @Option("Disable NPE as default")
  public static boolean check_npe = false;
  
  @Option("User defined forbidden exception")
  public static String forbidden_exception = null;
  ...
  @Option("Documented test name")
  public static String documented_test = "Documented_Failed_Test";
  
  @Option("Documented test output dir")
...
//  @Option("The package name for failure tests")
//  public static boolean failure_doc
