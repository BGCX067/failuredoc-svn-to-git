...
public class TestMultiNonInterferenceFaultMinimizer extends TestCase {
	...
	static void multi_faults_tests(int length, List<Integer> failed_indices) {
		FDUtils.stdln(" ===== start of a noninference test ===== ");
		...
		FDUtils.stdln("All original inputs: " + ints);
		...
		FDUtils.stdln("the failed_indices: " + failed_indices);
		FDUtils.stdln("minimized results: " + results);
		...
		FDUtils.stdln(" ----- end of a noninference test ---- ");
